...
$icer_id = explode(".", $_GET["a"])[1];

$icerik_cek = mysqli_query($db , "SELECT * FROM `konu` WHERE `id` = '$icer_id'");



if($icerik_cek->num_rows == 0){
    header("Location: ".$domain);
}else{
    $icerik = mysqli_fetch_assoc($icerik_cek);
}

mysqli_query($db, "UPDATE `konu` SET `goruntulenme` = `goruntulenme` + 1 WHERE `id` = '$icer_id'");
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="text-center mt-5"><h1><?php echo $icerik["ismi"]?></h1></div>
            <div class="mt-5">
                <?php echo $icerik["detay"]?>
            </div>
            <div class="mt-5">
                Tarih: <?php echo $icerik["tarih"]?> <br>
                Görüntülenme sayısı: <?php echo $icerik["goruntulenme"]?>
            </div>
            ...
            <div class="col-md-3 ">
                ...
                <div style="background-color: #dcdcdc;">
                    ...
                    <a href="<?php echo $domain?>b/<?php echo $url?>" style="text-decoration: none;">
